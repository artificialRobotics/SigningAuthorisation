...
echo =================> JSON payload crypto
java -jar ../target/SigningAuthorisation-0.0.1-SNAPSHOT-all.jar verify --mode crypto --alg ph --in .\result\Payload-Signature.json --pub-dir .\ --pub-file ps512_cert.pem --payload .\result\Payload.json --truststore DSS_TrustKeyStore.p12 --truststoreType PKCS12 --truststorePassword password --validationPolicy .\default-constraint-WebAPP.xml --detached --debug


echo =================> JSON payload eidas
java -jar ../target/SigningAuthorisation-0.0.1-SNAPSHOT-all.jar verify --mode eidas --alg ph --in .\result\Payload-Signature.json --pub-dir .\ --pub-file ps512_cert.pem --payload .\result\Payload.json --truststore DSS_TrustKeyStore.p12 --truststoreType PKCS12 --truststorePassword password --validationPolicy .\default-constraint-WebAPP.xml --detached --debug


echo =================> Hash payload crypto
REM java -jar ../target/SigningAuthorisation-0.0.1-SNAPSHOT-all.jar verify --mode crypto --alg ph --in .\result\Payload-Signature.json --pub-dir .\ --pub-file ps512_cert.pem --payloadHashFile .\result\HASH4SignaturePS512_bg_detached_canon.jws.txt --truststore DSS_TrustKeyStore.p12 --truststoreType PKCS12 --truststorePassword password --validationPolicy .\default-constraint-WebAPP.xml --detached


echo =================> Hash payload mixed
java -jar ../target/SigningAuthorisation-0.0.1-SNAPSHOT-all.jar verify --mode mixed --alg ph --in .\result\Payload-Signature.json --pub-dir .\ --pub-file ps512_cert.pem --payloadHashFile .\result\HASH4SignaturePS512_bg_detached_canon.jws.txt --truststore DSS_TrustKeyStore.p12 --truststoreType PKCS12 --truststorePassword password --validationPolicy .\default-constraint-WebAPP.xml --detached
