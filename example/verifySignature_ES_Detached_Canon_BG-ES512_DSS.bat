...
REM java -jar ../target/SigningAuthorisation-0.0.1-SNAPSHOT-all.jar verify --mode eidas --alg ph --canonicalize-payload jcs --in .\result\ES512_bg_detached_canon.jws --pub-dir .\ --pub-file es512_cert.pem --payload .\Payload.json --truststore DSS_TrustStore.p12 --truststoreType PKCS12 --truststorePassword password --validationPolicy .\default-constraint-WebAPP.xml --detached
